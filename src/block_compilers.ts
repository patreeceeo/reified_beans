...
//   compiler.addOpsToCurrentProc(newMachineOp("ClearArgs"));
// };
...
//     newMachineOp("PushArg", nextBlockValueField.getValue()),
//     // newMachineOp(
//     //   "Basic",
...
// export const boolean_messages_ifTrue_ifFalse: BlockCompiler = (
//   block,
//   compiler,
// ) => {
...
//     compiler.addOpsToCurrentProc(newMachineOp("PopState"));
//     compiler.popProc();
//   }
//   compiler
//     .addOpsToCurrentProc
